...
1. Read the tasks at `docs/loop/tasks.json` (in the project root)
2. Read the progress log at `docs/loop/progress.md` (check Codebase Patterns section first)
...
9. Update the tasks to set `passes: true` for the completed story
10. Append your progress to `docs/loop/progress.md`
